...
else
{
	...
	{
	$sql="CREATE TABLE $uname( `ID` INT NOT NULL AUTO_INCREMENT , `Name` VARCHAR(500) NOT NULL , `URL` VARCHAR(500) NOT NULL , `Embed` VARCHAR(500) NOT NULL , PRIMARY KEY (`ID`)) ENGINE = InnoDB";
	}
}
if ($con->query($sql) === TRUE)
{
